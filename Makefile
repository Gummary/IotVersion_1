...
# Generated by qmake (2.01a) (Qt 4.5.0) on: ?? 5? 21 10:13:52 2016
...
moc_WidgetKeyboard.cpp: ui_WidgetKeyboard.h \
		WidgetKeyboard.hpp
	/usr/local/Trolltech/QtEmbedded-4.5.0-arm-embedded/bin/moc $(DEFINES) $(INCPATH) WidgetKeyboard.hpp -o moc_WidgetKeyboard.cpp
