...
# Generated by qmake (2.01a) (Qt 4.5.0) on: ?? 3? 19 11:47:19 2016
...
moc_ledandmotor.cpp: moudle.h \
		...
		serialservice.h \
		ledandmotor.h
	/usr/local/Trolltech/QtEmbedded-4.5.0-arm-embedded/bin/moc $(DEFINES) $(INCPATH) ledandmotor.h -o moc_ledandmotor.cpp
