...
# Generated by qmake (2.01a) (Qt 4.5.0) on: ?? 4? 3 17:07:45 2016
...
SOURCES       = main.cpp \
		...
		clock.cpp \
		replays.cpp \
		camerainit.cpp moc_mainwindow.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Version1_01.0.0/ && $(COPY_FILE) --parents mainwindow.h posix_qextserialport.h qextserialbase.h qextserialport.h serialclass.h socketclass.h serialservice.h abstracemoudle.h moudle.h ledandmotor.h lib_json/json_batchallocator.h json/autolink.h json/config.h json/features.h json/forwards.h json/json.h json/reader.h json/value.h json/writer.h temperature.h clock.h replays.h camerainit.h .tmp/Version1_01.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp posix_qextserialport.cpp qextserialbase.cpp qextserialport.cpp serialclass.cpp socketclass.cpp moudle.cpp ledandmotor.cpp lib_json/json_reader.cpp lib_json/json_value.cpp lib_json/json_writer.cpp temperature.cpp clock.cpp replays.cpp camerainit.cpp .tmp/Version1_01.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/Version1_01.0.0/ && (cd `dirname .tmp/Version1_01.0.0` && $(TAR) Version1_01.0.0.tar Version1_01.0.0 && $(COMPRESS) Version1_01.0.0.tar) && $(MOVE) `dirname .tmp/Version1_01.0.0`/Version1_01.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Version1_01.0.0
